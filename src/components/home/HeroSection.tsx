  ...
  return (
    <div className="relative w-full overflow-hidden pt-28 sm:pt-36 pb-20 sm:pb-28 px-6 sm:px-8">
      ...
      >
        ...
        <motion.div
          variants={itemVariants}
          className="mt-12 sm:mt-14 flex w-full flex-col items-start space-y-3.5 pt-2 text-left select-none"
        >
          {/* 结构小标题 */}
          ...
          <p className="pt-2 font-mono text-[13px] sm:text-[14px] text-neutral-500 dark:text-[#a09a8e] text-left select-text">
            ...
            <a
              ...
              className="hover:text-neutral-900 dark:hover:text-[#ede7dc] hover:underline transition-colors"
            >
