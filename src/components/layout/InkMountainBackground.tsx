...
>
      ...
      <div className="absolute right-0 bottom-0 h-full flex items-end justify-end pointer-events-none z-10 pr-2 sm:pr-6 md:pr-12">
        <img
          ...
          className="h-[84%] sm:h-[90%] md:h-[94%] max-h-[460px] w-auto object-contain object-bottom drop-shadow-[0_8px_24px_rgba(0,0,0,0.10)] dark:drop-shadow-[0_12px_30px_rgba(0,0,0,0.9)] transition-all duration-300"
        />
      </div>
    </div>
  );
