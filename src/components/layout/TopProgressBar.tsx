...
* 纯 CSS 极简流体顶部进度条（适用于局部异步占位）
  */
  ...
  return (
   ...
   >
     <div className="w-full h-full bg-gradient-to-r from-transparent via-neutral-400 to-neutral-800 dark:via-neutral-500 dark:to-white animate-top-progress" />
   </div>
...
>
{/* 前端微光发丝光晕（极细柔和，绝无刺眼粗白雾） */} <div className="absolute right-0 top-1/2 -translate-y-1/2 h-[2px] w-8 bg-gradient-to-r from-transparent to-white/90 dark:to-white blur-[0.5px]" /> </div> </div>
);
}
